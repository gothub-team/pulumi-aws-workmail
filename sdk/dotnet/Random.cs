...
{
    [AwsworkmailResourceType("awsworkmail:index:Random")]
    public partial class Random : global::Pulumi.CustomResource
    {
        ...
        public Random(string name, RandomArgs args, CustomResourceOptions? options = null)
            : base("awsworkmail:index:Random", name, args ?? new RandomArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Random(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("awsworkmail:index:Random", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                PluginDownloadURL = "https://github.com/gothub-team/pulumi-awsworkmail/releases/download/0.0.10/",
            };
