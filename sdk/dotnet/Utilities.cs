...
namespace Pulumi.Awsworkmail
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "https://github.com/gothub-team/pulumi-awsworkmail/releases/download/0.0.10/";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Awsworkmail.version.txt");
    ...
    internal sealed class AwsworkmailResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public AwsworkmailResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
